...
# Создание прямоугольников для кирпичей перед началом игры
brick_image = pygame.image.load("C:/Users/MrMAD/Documents/GitHub/OB/img/brik.png")
...
while running:
    ...
    brick_rects = [pygame.Rect(x, y, brick_width, brick_height) for x, y in bricks]  # Пересоздание прямоугольников для актуальных кирпичей
    for i, brick_rect in enumerate(brick_rects):
        if brick_rect.collidepoint(ball_x, ball_y):
            ...
            break  # Выход после уничтожения одного кирпича
